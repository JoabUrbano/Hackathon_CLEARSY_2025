...
THEORY ListSubstitutionX IS
  ...
  List_Substitution(Machine(CONTROLLER),control)==(current_action,current_objective: (current_action: ACTIONS & current_objective: OBJECTIVES & (current_action = TRANSLATE_OPEN_DOOR_A => pressure_sensor_l = PRESSURE_A & contact_sensor_b = TRUE) & (current_action = TRANSLATE_OPEN_DOOR_B => pressure_sensor_l = PRESSURE_B & contact_sensor_a = TRUE) & (current_action = ADAPT_PRESSURE_L_TO_A => contact_sensor_a = TRUE & contact_sensor_b = TRUE & pressure_sensor_l/=PRESSURE_A) & (current_action = ADAPT_PRESSURE_L_TO_B => contact_sensor_a = TRUE & contact_sensor_b = TRUE & pressure_sensor_l/=PRESSURE_B)))
END
&
